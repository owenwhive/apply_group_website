  ...
  <nav class="navbar navbar-expand-lg bg-transparent w-100" style="position: absolute;">
    <div class="container">
      <a href="{{url('/')}}" class="brand-logo"><img src="assets/images/image 20.png" alt="Logo"></a>
      <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent"
        aria-controls="navbarSupportedContent" aria-expanded="false" id="navbarToggler" aria-label="Toggle navigation">
      ...
      <div class="collapse navbar-collapse font-xs px-3 d-none d-md-none d-lg-block">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="color: #808080;">
          <li class="nav-item">
            <a class="nav-link text-white" aria-current="page" href="{{ url('/recruitment')}}">Recruitment Partners</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-white" href="{{ url('/institution')}}">Institutions</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-white" href="{{ url('/courses')}}">Explore Courses</a>
          </li>
        </ul>
        <form class="d-flex align-items-center" role="search" style="color: #ffffff;">
          <div class="px-2">

            <i class="bi bi-search font-md text-white"></i>
            <i class="bi bi-filter-right px-2 font-md text-white"></i>
            <span class="font-md text-white">|</span>
          </div>
